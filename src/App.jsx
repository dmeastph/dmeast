/**
 * DMEAST — Medical Solutions Platform  v16.0
 *
...
const DMEAST_LOGO_DATA = "data:image/jpeg;base64,";
...
async function generateDocumentPDF({ order, docType, docNumber, validityDays = 30, vatTreatment }) {
  ...
  let y = 0;  // start at very top for header band
  
  // ── HEADER BAND (black bg with logo) ──────────────────────
  // The DMEAST logo is designed for dark backgrounds, so we use a black band
  const headerBandHeight = 70;
  setFill([0, 0, 0]); // black
  pdf.rect(0, 0, pageWidth, headerBandHeight, "F");
  
  // Add logo to left side of black band
  try {
    if (DMEAST_LOGO_DATA) {
      // Logo aspect ratio is 800x565 = 1.42:1
      // Display at height ~50pt, width auto-calculated
      const logoH = 50;
      const logoW = logoH * 1.42; // ~71pt
      pdf.addImage(DMEAST_LOGO_DATA, "JPEG", margin, (headerBandHeight - logoH)/2, logoW, logoH);
    }
  } catch(e) {
    // Fallback to text logo if image fails
    pdf.setTextColor(204, 47, 60);
    pdf.setFont("helvetica", "bold");
    pdf.setFontSize(22);
    pdf.text("DM EAST", margin, headerBandHeight/2 + 8);
  }
  
  // Document title (right side, white text on black)
  pdf.setTextColor(255, 255, 255);
  pdf.setFont("helvetica", "bold");
  pdf.setFontSize(18);
  pdf.text(DOC_TITLES[docType], pageWidth - margin, headerBandHeight/2 - 2, { align: "right" });
  
  // Doc number (right, below title — gold-ish)
  pdf.setTextColor(240, 168, 28);
  pdf.setFont("helvetica", "normal");
  pdf.setFontSize(10);
  pdf.text(`No. ${docNumber}`, pageWidth - margin, headerBandHeight/2 + 16, { align: "right" });
...
function TopAnnouncementBar(){
  ...
  return (
    <div style={{
      background: `linear-gradient(90deg, ${ds.color.gold} 0%, ${ds.color.goldBright} 50%, ${ds.color.gold} 100%)`,
      color: "#fff",
      padding: "8px 28px",
      fontSize: 12.5,
      fontWeight: 600,
...
function HeroSectionV16({setPage}){
  return (
    <section style={{
      background: `linear-gradient(135deg, ${ds.color.canvasWarm} 0%, ${ds.color.white} 50%, ${ds.color.canvasGold} 100%)`,
      padding: "60px 0 80px",
      position: "relative",
      overflow: "hidden",
    }}>
      ...
      <div style={{maxWidth:1280,margin:"0 auto",padding:"0 28px",position:"relative",zIndex:1}}>
        <div className="dm-hero-grid" style={{display:"grid",gridTemplateColumns:"1.1fr 1fr",gap:60,alignItems:"center"}}>
          ...
          <div>
            ...
            {/* Search bar — dominant CTA on PharmaHouse */}
            ...
            {/* Dual CTA */}
            <div className="dm-fade-up dm-fade-up-4" style={{display:"flex",gap:10,flexWrap:"wrap",marginBottom:32}}>
          ...
          {/* RIGHT: Visual - product collage / floating cards */}
          <div className="dm-hero-visual" style={{position:"relative",minHeight:480,display:"flex",alignItems:"center",justifyContent:"center"}}>
            ...
            <div style={{
              ...
              border:`1px solid ${ds.color.redBorder}`,
            }}/>
            
            {/* Center: Floating product card */}
            <div style={{
              position:"relative",
              background:"#fff",
              ...
              <div style={{fontSize:32,marginBottom:8}}>💊</div>
              <div style={{fontSize:11,fontWeight:700,color:ds.color.gold,letterSpacing:"0.06em",textTransform:"uppercase",marginBottom:4}}>Featured</div>
              <div style={{fontSize:15,fontWeight:700,color:ds.color.textDark,marginBottom:4}}>Quality Pharmaceuticals</div>
              <div style={{fontSize:12,color:ds.color.textMuted,marginBottom:12}}>From authorized suppliers</div>
              <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
                <span style={{fontSize:11,color:ds.color.textMuted}}>Browse 500+</span>
                <span style={{padding:"4px 10px",background:ds.color.redLight,color:ds.color.red,borderRadius:ds.radius.pill,fontSize:11,fontWeight:700}}>SHOP →</span>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{width:38,height:38,borderRadius:"50%",background:ds.color.successBg,display:"flex",alignItems:"center",justifyContent:"center",fontSize:18}}>✓</div>
              <div>
                <div style={{fontSize:11,fontWeight:700,color:ds.color.success}}>Order Delivered</div>
                <div style={{fontSize:10,color:ds.color.textMuted}}>QC Hospital · Today</div>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{width:38,height:38,borderRadius:"50%",background:ds.color.gold+"33",display:"flex",alignItems:"center",justifyContent:"center",fontSize:18}}>🏥</div>
              <div>
                <div style={{fontSize:11,fontWeight:700,color:"#fff"}}>50+ Institutions</div>
                <div style={{fontSize:10,color:"rgba(255,255,255,0.6)"}}>Trust DMEAST</div>
              </div>
            </div>
            
            {/* Floating bottom-left small */}
            <div style={{
              position:"absolute",
              bottom:"22%",
              left:"8%",
