    ...
    <div style={{fontFamily:ds.font.body,minHeight:"100vh",background:ds.color.surface,color:ds.color.textBody}}>
      ...
      <Suspense fallback={<PageSpinner/>}>
        <Routes>
          ...
          <Route path="/admin" element={isAdmin?<AdminDashboard user={user}/>:<div style={{paddingTop:67,minHeight:"80vh",display:"flex",alignItems:"center",justifyContent:"center"}}><div style={{textAlign:"center",color:ds.color.textMuted}}>⛔ Admin access only.</div></div>}/>
