...
// Edit ADMIN_ROLES to add/remove staff access.

export const ADMIN_EMAILS = ["info@dmeastph.com", "admin@dmeastph.com"]; // Legacy - kept for backward compat

// ─── v15 ROLE-BASED ACCESS CONTROL ───────────────────────────────────────────
// Map admin emails to their role.
