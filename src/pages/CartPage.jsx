...
export function CartPage({cart,removeFromCart,updateQty,setPage,user,onOrderComplete}){
  ...
  if(step===5 && successOrder) return(
    <div style={{paddingTop:83,background:ds.color.canvas,minHeight:"100vh"}}>
  ...
  if(cart.length===0) return(
    <div style={{paddingTop:83,minHeight:"80vh",background:`linear-gradient(180deg, ${ds.color.canvas} 0%, ${ds.color.canvasWarm} 100%)`,display:"flex",alignItems:"center",justifyContent:"center"}}>
  ...
  if(orderMode===null) return(
    <div style={{paddingTop:83,minHeight:"80vh",background:ds.color.canvas,display:"flex",alignItems:"center",justifyContent:"center"}}>
  ...
  if(orderMode==="intl"){
    ...
    return(
      <div style={{paddingTop:83,background:ds.color.canvas,minHeight:"80vh"}}>
