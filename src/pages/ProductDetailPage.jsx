...
export default function ProductDetailPage({ addToCart, wishlist, toggleWishlist, setPage, user }) {
  ...
  if (products.length === 0) {
    return <div style={{ paddingTop: 103, display: "flex", justifyContent: "center", padding: "100px 28px" }}><Spinner /></div>;
  }

  if (!product) {
    return (
      <div style={{ paddingTop: 103, textAlign: "center", padding: "100px 28px" }}>
